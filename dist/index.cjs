...
var Message = class {
  ...
  message;
  function;
  constructor(type, message, functionType = null) {
    this.type = type;
  ...
  toSocketData() {
    return {
      ...
      request: this.function?.toString() || void 0
    };
  }
  static fromJson(json) {
    return parseMessageFromJson(json, JSON.parse(json).type);
  }
};
function parseMessageFromJson(json, type) {
...
function encodeMessageToJson(message) {
